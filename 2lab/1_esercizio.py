...
while nuovo_n != -1:
    ...
    if len(lista_N) == 0:
        print() ; print("Hai creato una lista vuota. Non posso operare con una lista vuota, sorry !") ; print()
    else:
         print() ; print() ; print()
         print("ERROR 404, hai inserito -1 !!!") ; print()
         ...
         print("Il minimo tra i numeri inseriti è: ", min(lista_N)) ; print()
